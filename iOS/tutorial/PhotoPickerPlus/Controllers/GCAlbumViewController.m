...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    else
    {
        ...
        [acVC setServiceName:self.serviceName];
    }
...
- (void)getAlbumsFromAccount
{
    ...
    [GCServiceAccount getDataForServiceWithName:self.serviceName accountWithID:self.accountID withSuccess:^(GCResponseStatus *responseStatus, NSArray *folders, NSArray *files) {
        [MBProgressHUD hideHUDForView:self.navigationController.view animated:NO];
        self.albums = [[NSMutableArray alloc] initWithArray:folders];
        [self.tableView reloadData];
