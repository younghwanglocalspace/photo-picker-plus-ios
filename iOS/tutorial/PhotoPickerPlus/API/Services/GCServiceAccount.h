...
//+ (void)getDataForServiceWithName:(NSString *)serviceName accountWithID:(NSNumber *)accountID withSuccess:(void (^)(GCResponseStatus *responseStatus, NSArray *folders, NSArray *files))success failure:(void (^)(NSError *error))failure;
