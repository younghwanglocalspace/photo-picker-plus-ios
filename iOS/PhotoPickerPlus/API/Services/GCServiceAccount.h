...
/**
 ...
 @param success A block object to be executed when the operation finishes successfully. This block has no return value and takes two arguments: the responseStatus received from the server response, and an array object containing accounts from the server response data.
 ...
 @warning This method require `GCResponseStatus` class. Add an `#import <Chute-SDK/GCResponseStatus.h> in your header file.
*/
...
/**
 ...
 @param success A block object to be executed when the operation finishes successfully. This block has no return value and takes two arguments: the responseStatus from the server response, an array containing asssets from the server response data.
 
 @param failure A block object to be executed when the operation finishes unsuccessfully, or that finishes successfully, but encountered an error while parsing the response data. This block has no return value and takes one argument: `NSError` object describing the network or parsing error that occurred.
 
 @warning This method require `GCResponseStatus` class. Add an `#import <Chute-SDK/GCResponseStatus.h> in your header file.
*/
+ (void)postSelectedImages:(NSArray *)selectedImages success:(void(^)(GCResponseStatus *responseStatus, NSArray *assets))success failure:(void(^)(NSError *))failure;
