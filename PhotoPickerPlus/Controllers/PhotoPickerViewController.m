...
- (id)init
{
    ...
    if (self) {
        ...
        [self.photoPickerViewController setOauth2Client:[GCOAuth2Client clientWithClientID:[[GCConfiguration configuration] appId] clientSecret:[[GCConfiguration configuration] appSecret]]];
